        ...
        child: Builder(builder: (context) {
          return Column(
            children: [
              ...
              // Result column - using Expanded to fill available space
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                                ...
                                (!appState.finding &&
                                    ...
                                    (appState.stronglyAssociatedWordsController
                                        ...
                                        appState.similarlySpelledWordsController
                                            .text.isNotEmpty ||
                                        appState.similarSoundingWordsController
                                            .text.isNotEmpty)),
                            child: Padding(
                      ...
                      Visibility(
                        ...
                        child: Container(
                          height: (appState.outputPhoneticController.text
                                      .isNotEmpty ||
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              Visibility(
                                ...
                                child: ExpansionTile(
                                  ...
                                  onExpansionChanged: (bool expanded) {
                                    HapticFeedback.lightImpact();
                                    setState(() {
                                      appState.definitionsTileExpanded =
                                          expanded;
                                    });
                                  },
                              ...
                              Visibility(
                                ...
                                child: ExpansionTile(
                                  ...
                                  title: Row(
                                    ...
                                    children: [
                                      Text(
                                        appState.stronglyAssociatedWordsCount >
                                                1
                              ...
                              Visibility(
                                ...
                                child: ExpansionTile(
                                  ...
                                  onExpansionChanged: (bool expanded) {
                                    HapticFeedback.lightImpact();
                                    setState(() {
                                      appState.precededByTileExpanded =
                                          expanded;
                                    });
                                  },
                                ),
                              ...
                              Visibility(
                                ...
                                child: ExpansionTile(
                                  ...
                                  onExpansionChanged: (bool expanded) {
                                    HapticFeedback.lightImpact();
                                    setState(() {
                                      appState.followedByTileExpanded =
                                          expanded;
                                    });
                                  },
                                ),
                              ...
                              Visibility(
                                visible: appState.adjectivesModifiedController
                                    .text.isNotEmpty,
                                child: ExpansionTile(
                                  tilePadding: EdgeInsets.all(0),
                                  expandedAlignment: Alignment.topLeft,
                              ...
                              Visibility(
                                visible: appState
                                    .hypernymsController.text.isNotEmpty,
                                child: ExpansionTile(
                                  tilePadding: EdgeInsets.all(0),
                                  expandedAlignment: Alignment.topLeft,
                                  title: Row(
                        ...
                        children: [
                          ...
                          Tooltip(
                            ...
                            child: IconButton(
                                ...
                                icon: Icon(
                                  Icons.delete,
                                  color: (appState.meaningDefinitionsMap
                                              .isNotEmpty ||
                                          appState
                                              .stronglyAssociatedWordsController
                                              .text
                        ...
                        children: [
                          ...
                          Visibility(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () async {
                                menuResult =
                                    await Dialogs.showMoreApps(context);
